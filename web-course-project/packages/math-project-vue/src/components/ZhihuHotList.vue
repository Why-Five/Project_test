...
<template>
  <div class="min-h-screen transition-colors duration-300" :class="isDark ? 'dark bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'">
    <div class="max-w-4xl mx-auto p-4">
      ...
      <div v-if="loading" class="flex justify-center items-center py-16">
        <div class="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2" :class="isDark ? 'border-blue-400' : 'border-blue-500'"></div>
      </div>
        ...
        >
          ...
          <div class="flex items-start">
            ...
            <div class="flex-1">
              ...
              <!-- 摘要 -->
              <p v-if="item.target?.excerpt" class="text-sm mb-3 line-clamp-2" :class="isDark ? 'text-gray-300' : 'text-gray-600'">
                {{ item.target.excerpt }}
              </p>
              
              <!-- 底部信息 -->
              <div class="flex flex-wrap items-center text-xs gap-x-4 gap-y-2" :class="isDark ? 'text-gray-400' : 'text-gray-500'">
                <!-- 作者信息 -->
